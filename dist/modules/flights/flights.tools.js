...
let FlightTools = class FlightTools {
    duffelService;
    constructor(duffelService) {
        this.duffelService = duffelService;
    }
    async searchFlights(input, ctx) {
            ...
            return {
                ...
                ...(returnSlice && {
                    return: {
                        ...
                        segments: returnSlice.segments.map((seg) => ({
                            origin: seg.origin.iata_code,
                            destination: seg.destination.iata_code,
                            departingAt: seg.departing_at,
                            arrivingAt: seg.arriving_at,
    ...
    async getFlightDetails(input, ctx) {
        ...
        return {
            ...
            passengers: offer.passengers.map((pax) => ({
                ...
                baggageAllowance: pax.baggages?.map((bag) => ({
                    type: bag.type,
    ...
    async searchAirports(input, ctx) {
        ...
        return {
            query: input.query,
            results: places.slice(0, 10).map((place) => ({
                id: place.id,
                name: place.name,
...
], FlightTools.prototype, "searchFlights", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FlightTools.prototype, "getFlightDetails", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FlightTools.prototype, "searchAirports", null);
FlightTools = __decorate([
    Injectable({ deps: [DuffelService] }),
    __metadata("design:paramtypes", [DuffelService])
], FlightTools);
export { FlightTools };
//# sourceMappingURL=flights.tools.js.map