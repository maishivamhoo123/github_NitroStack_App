...
let FlightResources = class FlightResources {
    duffelService;
...
`;
    ...
    async getAirlineCodes(ctx) {
        try {
            const airlines = await this.duffelService.getAirlines();
            return {
                airlines: airlines.slice(0, 50).map((airline) => ({
...
], FlightResources.prototype, "getSearchHistory", null);
__decorate([
    Resource({
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FlightResources.prototype, "getPopularRoutes", null);
__decorate([
    Resource({
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FlightResources.prototype, "getBookingGuide", null);
__decorate([
    Resource({
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FlightResources.prototype, "getAirlineCodes", null);
FlightResources = __decorate([
    Injectable({ deps: [DuffelService] }),
    __metadata("design:paramtypes", [DuffelService])
], FlightResources);
export { FlightResources };
//# sourceMappingURL=flights.resources.js.map