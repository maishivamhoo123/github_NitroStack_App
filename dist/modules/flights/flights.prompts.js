...
let FlightPrompts = class FlightPrompts {
    duffelService;
    constructor(duffelService) {
        this.duffelService = duffelService;
    }
    async flightSearchAssistant(input, ctx) {
...
Respond to EXACTLY what the user asked - nothing more.`;
    ...
    async flightComparison(input, ctx) {
        const offers = await Promise.all(input.offerIds.map((id) => this.duffelService.getOffer(id)));
...
Be concise but informative.`;
    ...
    async bookingAssistant(input, ctx) {
...
], FlightPrompts.prototype, "flightSearchAssistant", null);
__decorate([
    Prompt({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FlightPrompts.prototype, "flightComparison", null);
__decorate([
    Prompt({
        name: 'travel_tips',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FlightPrompts.prototype, "travelTips", null);
__decorate([
    Prompt({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], FlightPrompts.prototype, "bookingAssistant", null);
FlightPrompts = __decorate([
    Injectable({ deps: [DuffelService] }),
    __metadata("design:paramtypes", [DuffelService])
], FlightPrompts);
export { FlightPrompts };
//# sourceMappingURL=flights.prompts.js.map